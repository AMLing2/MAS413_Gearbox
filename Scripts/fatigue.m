...
%%%%% Mean & Amplitude stress w/stress concentration (Ductile materials) %%%%% MAS236 L3 s19 & s21
% Axial
...
% Size factor (MAS236 L3 s44 & Machine Design page 367)
if d_shaft <= 8
    C_size = 1;
elseif d_shaft <= 250
...
% Surface factor (MAS236 L3 s45 & Machine Design page 369)
...
% Temperature factor (MAS236 L3 s47 & Machine Design page 371)
...
% Reliability factor (MAS236 L3 s48 & Machine Design page 371)
...
% Other factors: MAS236 lecture 3 slide 49
